...
setup(
    ...
    author="Etalab",
    author_email="pypi@data.public.lu",
    packages=find_packages(),
    include_package_data=True,
    python_requires=">=3.7",
    install_requires=get_requirements(),
    entry_points={
        "udata.themes": ["gouvfr = udata_front.theme.gouvfr",],
        "udata.models": ["front = udata_front.models",],
        "udata.front": "front = udata_front.frontend",
        "udata.apis": ["front_oembed = udata_front.views.oembed",],
        "udata.harvesters": ["maaf = udata_front.harvesters.maaf:MaafBackend",],
        "udata.tasks": ["front = udata_front.tasks",],
    },
    license="LGPL",
    zip_safe=False,

...
def set_po_metadata(filename, locale):
    ...
    catalog.msgid_bugs_address = "data.gouv@data.public.lu"
    catalog.language_team = "Data.public.lu Team <data.gouv@data.public.lu>"
    catalog.last_translator = "Data.public.lu Team <data.gouv@data.public.lu>"
